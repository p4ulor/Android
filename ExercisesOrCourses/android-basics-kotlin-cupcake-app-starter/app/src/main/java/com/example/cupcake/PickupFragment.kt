...
class PickupFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.apply {
            lifecycleOwner = viewLifecycleOwner // "Lifecycle owner to observe LiveData" "LiveData observer observes the changes to the app's data only if the lifecycle owner is in active states" "For the UI elements to automatically update, you have to associate binding.lifecycleOwner" https://developer.android.com/codelabs/basic-android-kotlin-training-shared-viewmodel#7
